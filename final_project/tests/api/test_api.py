...
class TestApi:
    ...
    @allure.step('POST products list')
    ...
    @allure.step('Check different codes from response')
    ...
    def test_different_codes_from_response(self, status_code):
